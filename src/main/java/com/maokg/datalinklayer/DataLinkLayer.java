package com.maokg.datalinklayer;


import jpcap.NetworkInterfaceAddress;
import jpcap.packet.EthernetPacket;
import jpcap.packet.Packet;
import com.maokg.protocol.ARPProtocolLayer;
import com.maokg.protocol.ICMPProtocolLayer;
import com.maokg.utils.PacketProvider;
...
public class DataLinkLayer extends PacketProvider implements jpcap.PacketReceiver{   
	    ...
	    public void sendData(byte[] data, byte[] dstMacAddress, short frameType) {
			...
			//将发生的数据包写成文件以便于调试。
			String path = "/Users/maokg/Downloads/dump.txt";
			try {
